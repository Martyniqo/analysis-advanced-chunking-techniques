...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/446', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.PAGE_HEADER: 'page_header'>, 'prov': [{'page_no': 7, 'bbox': {'l': 53.79800033569336, 't': 731.6909790039062, 'r': 347.0169982910156, 'b': 723.4240112304688, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 71)}]}]
- **headings**: ['Baselines for Object Detection']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/447', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.PAGE_HEADER: 'page_header'>, 'prov': [{'page_no': 7, 'bbox': {'l': 365.7569885253906, 't': 731.6909790039062, 'r': 558.2030029296875, 'b': 723.4240112304688, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 48)}]}]
- **headings**: ['Baselines for Object Detection']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/448', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 7, 'bbox': {'l': 53.50199890136719, 't': 705.1270141601562, 'r': 295.64898681640625, 'b': 663.7769775390625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 206)}]}]
- **headings**: ['Baselines for Object Detection']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
Table 3: Performance of a Mask R-CNN R50 network in mAP@0.5-0.95 scores trained on DocLayNet with di/fferent class label sets. The reduced label sets were obtained by either down-mapping or dropping labels.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/449', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.CAPTION: 'caption'>, 'prov': [{'page_no': 7, 'bbox': {'l': 317.65899658203125, 't': 705.1270141601562, 'r': 559.8070068359375, 'b': 663.7769775390625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 184)}]}]
- **headings**: ['Baselines for Object Detection']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
Table 4: Performance of a Mask R-CNN R50 network with document-wise and page-wise split for di/fferent label sets. Naive page-wise split will result in /tildelow 10% point improvement.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/tables/2', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TABLE: 'table'>, 'prov': [{'page_no': 7, 'bbox': {'l': 80.3552017211914, 't': 641.063720703125, 'r': 267.0082702636719, 'b': 496.55450439453125, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 0)}]}]
- **headings**: ['Baselines for Object Detection']
- **captions**: ['Table 4: Performance of a Mask R-CNN R50 network with document-wise and page-wise split for di/fferent label sets. Naive page-wise split will result in /tildelow 10% point improvement.']
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}

### Content:

Caption, 11 = 68. Caption, 6 = Text. Caption, 5 = Text. Caption, 4 = Text. Footnote, 11 = 71. Footnote, 6 = Text. Footnote, 5 = Text. Footnote, 4 = Text. Formula, 11 = 60. Formula, 6 = Text. Formula, 5 = Text. Formula, 4 = Text. List-item, 11 = 81. List-item, 6 = Text. List-item, 5 = 82. List-item, 4 = Text. Page-footer, 11 = 62. Page-footer, 6 = 62. Page-footer, 5 = -. Page-footer, 4 = -. Page-header, 11 = 72. Page-header, 6 = 68. Page-header, 5 = -. Page-header, 4 = -. Picture, 11 = 72. Picture, 6 = 72. Picture, 5 = 72. Picture, 4 = 72. Section-header, 11 = 68. Section-header, 6 = 67. Section-header, 5 = 69. Section-header, 4 = 68. Table, 11 = 82. Table, 6 = 83. Table, 5 = 82. Table, 4 = 82. Text, 11 = 85. Text, 6 = 84. Text, 5 = 84. Text, 4 = 84. Title, 11 = 77. Title, 6 = Sec.-h.. Title, 5 = Sec.-h.. Title, 4 = Sec.-h.. Overall, 11 = 72. Overall, 6 = 73. Overall, 5 = 78. Overall, 4 = 77
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/453', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 7, 'bbox': {'l': 53.46699905395508, 't': 234.28799438476562, 'r': 295.5570068359375, 'b': 83.447998046875, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 919)}]}]
- **headings**: ['Impact of Class Labels']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}

### Content:

The choice and number of labels can have a signi/ficant e/ffect on the overall model performance. Since PubLayNet, DocBank and DocLayNet all have di/fferent label sets, it is of particular interest to understand and quantify this in/fluence of the label set on the model performance. We investigate this by either down-mapping labels into more common ones (e.g. Caption → Text ) or excluding them from the annotations entirely. Furthermore, it must be stressed that all mappings and exclusions were performed on the data before model training. In Table 3, we present the mAP scores for a Mask R-CNN R50 network on di/fferent label sets. Where a label is down-mapped, we show its corresponding label, otherwise it was excluded. We present three di/fferent label sets, with 6, 5 and 4 di/fferent labels respectively. The set of 5 labels contains the same labels as PubLayNet. However, due to the di/fferent de/finition of
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/tables/3', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TABLE: 'table'>, 'prov': [{'page_no': 7, 'bbox': {'l': 352.97747802734375, 't': 641.208740234375, 'r': 522.9158935546875, 'b': 485.73419189453125, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 0)}]}]
- **headings**: ['Impact of Class Labels']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
Caption, 11.Doc = 68. Caption, 11.Page = 83. Caption, 5.Doc = . Caption, 5.Page = . Footnote, 11.Doc = 71. Footnote, 11.Page = 84. Footnote, 5.Doc = . Footnote, 5.Page = . Formula, 11.Doc = 60. Formula, 11.Page = 66. Formula, 5.Doc = . Formula, 5.Page = . List-item, 11.Doc = 81. List-item, 11.Page = 88. List-item, 5.Doc = 82. List-item, 5.Page = 88. Page-footer, 11.Doc = 62. Page-footer, 11.Page = 89. Page-footer, 5.Doc = . Page-footer, 5.Page = . Page-header, 11.Doc = 72. Page-header, 11.Page = 90. Page-header, 5.Doc = . Page-header, 5.Page = . Picture, 11.Doc = 72. Picture, 11.Page = 82. Picture, 5.Doc = 72. Picture, 5.Page = 82. Section-header, 11.Doc = 68. Section-header, 11.Page = 83. Section-header, 5.Doc = 69. Section-header, 5.Page = 83. Table, 11.Doc = 82. Table, 11.Page = 89. Table, 5.Doc = 82. Table, 5.Page = 90. Text, 11.Doc = 85. Text, 11.Page = 91. Text, 5.Doc = 84. Text, 5.Page = 90. Title, 11.Doc = 77. Title, 11.Page = 81. Title, 5.Doc = . Title, 5.Page = . All, 11.Doc = 72. All, 11.Page = 84. All, 5.Doc = 78. All, 5.Page = 87
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/454', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 7, 'bbox': {'l': 317.6860046386719, 't': 460.59600830078125, 'r': 559.5850219726562, 'b': 375.510009765625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 470)}]}]
- **headings**: ['Impact of Class Labels']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/456', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 7, 'bbox': {'l': 317.62298583984375, 't': 347.40301513671875, 'r': 559.7139892578125, 'b': 196.56300354003906, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 856)}]}]
- **headings**: ['Impact of Document Split in Train and Test Set']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}

### Content:

Many documents in DocLayNet have a unique styling. In order to avoid over/fitting on a particular style, we have split the train-, test- and validation-sets of DocLayNet on document boundaries, i.e. every document contributes pages to only one set. To the best of our knowledge, this was not considered in PubLayNet or DocBank. To quantify how this a/ffects model performance, we trained and evaluated a Mask R-CNN R50 model on a modi/fied dataset version. Here, the train-, test- and validation-sets were obtained by a randomised draw over the individual pages. As can be seen in Table 4, the di/fference in model performance is surprisingly large: pagewise splitting gains ˜ 10% in mAP over the document-wise splitting. Thus, random page-wise splitting of DocLayNet can easily lead to accidental overestimation of model performance and should be avoided.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/458', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 7, 'bbox': {'l': 317.6860046386719, 't': 168.45599365234375, 'r': 559.18798828125, 'b': 83.36000061035156, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 522)}]}]
- **headings**: ['Dataset Comparison']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}

### Content:

Throughout this paper, we claim that DocLayNet's wider variety of document layouts leads to more robust layout detection models. In Table 5, we provide evidence for that. We trained models on each of the available datasets (PubLayNet, DocBank and DocLayNet) and evaluated them on the test sets of the other datasets. Due to the di/fferent label sets and annotation styles, a direct comparison is not possible. Hence, we focussed on the common labels among the datasets. Between PubLayNet and DocLayNet, these are Picture ,
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/459', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.PAGE_HEADER: 'page_header'>, 'prov': [{'page_no': 8, 'bbox': {'l': 53.79800033569336, 't': 731.6909790039062, 'r': 558.2030029296875, 'b': 723.4240112304688, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 130)}]}]
- **headings**: ['Dataset Comparison']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/460', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.CAPTION: 'caption'>, 'prov': [{'page_no': 8, 'bbox': {'l': 53.50199890136719, 't': 705.1270141601562, 'r': 295.64898681640625, 'b': 641.8590087890625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 298)}]}]
- **headings**: ['Dataset Comparison']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/tables/4', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TABLE: 'table'>, 'prov': [{'page_no': 8, 'bbox': {'l': 72.6590347290039, 't': 619.5191650390625, 'r': 274.83465576171875, 'b': 452.1459655761719, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 0)}]}]
- **headings**: ['Dataset Comparison']
- **captions**: ['Table 5: Prediction Performance (mAP@0.5-0.95) of a Mask R-CNN R50 network across the PubLayNet, DocBank & DocLayNet data-sets. By evaluating on common label classes of each dataset, we observe that the DocLayNet-trained model has much less pronounced variations in performance across all datasets.']
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}

### Content:

PubLayNet (PLN), labels = Figure. PubLayNet (PLN), Testing on.PLN = 96. PubLayNet (PLN), Testing on.DB = 43. PubLayNet (PLN), Testing on.DLN = 23. PubLayNet (PLN), labels = Sec-header. PubLayNet (PLN), Testing on.PLN = 87. PubLayNet (PLN), Testing on.DB = -. PubLayNet (PLN), Testing on.DLN = 32. PubLayNet (PLN), labels = Table. PubLayNet (PLN), Testing on.PLN = 95. PubLayNet (PLN), Testing on.DB = 24. PubLayNet (PLN), Testing on.DLN = 49. PubLayNet (PLN), labels = Text. PubLayNet (PLN), Testing on.PLN = 96. PubLayNet (PLN), Testing on.DB = -. PubLayNet (PLN), Testing on.DLN = 42. PubLayNet (PLN), labels = total. PubLayNet (PLN), Testing on.PLN = 93. PubLayNet (PLN), Testing on.DB = 34. PubLayNet (PLN), Testing on.DLN = 30. DocBank (DB), labels = Figure. DocBank (DB), Testing on.PLN = 77. DocBank (DB), Testing on.DB = 71. DocBank (DB), Testing on.DLN = 31. DocBank (DB), labels = Table. DocBank (DB), Testing on.PLN = 19. DocBank (DB), Testing on.DB = 65. DocBank (DB), Testing on.DLN = 22. DocBank (DB), labels = total. DocBank (DB), Testing on.PLN = 48. DocBank (DB), Testing on.DB = 68. DocBank (DB), Testing on.DLN = 27. DocLayNet (DLN), labels = Figure. DocLayNet (DLN), Testing on.PLN = 67. DocLayNet (DLN), Testing on.DB = 51. DocLayNet (DLN), Testing on.DLN = 72. DocLayNet (DLN), labels = Sec-header. DocLayNet (DLN), Testing on.PLN = 53. DocLayNet (DLN), Testing on.DB = -. DocLayNet (DLN), Testing on.DLN = 68. DocLayNet (DLN), labels = Table. DocLayNet (DLN), Testing on.PLN = 87. DocLayNet (DLN), Testing on.DB = 43. DocLayNet (DLN), Testing on.DLN = 82. DocLayNet (DLN), labels = Text. DocLayNet (DLN), Testing on.PLN = 77. DocLayNet (DLN), Testing on.DB = -. DocLayNet (DLN), Testing on.DLN = 84. DocLayNet (DLN), labels = total. DocLayNet (DLN), Testing on.PLN = 59. DocLayNet (DLN), Testing on.DB = 47. DocLayNet (DLN), Testing on.DLN = 78
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/461', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 8, 'bbox': {'l': 53.79800033569336, 't': 401.0790100097656, 'r': 294.0469970703125, 'b': 348.8599853515625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 297)}]}]
- **headings**: ['Dataset Comparison']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
Section-header , Table and Text . Before training, we either mapped or excluded DocLayNet's other labels as speci/fied in table 3, and also PubLayNet's List to Text . Note that the di/fferent clustering of lists (by list-element vs. whole list objects) naturally decreases the mAP score for Text .
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/462', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 8, 'bbox': {'l': 53.46699905395508, 't': 346.2850036621094, 'r': 295.5589904785156, 'b': 206.4040069580078, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 794)}]}]
- **headings**: ['Dataset Comparison']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
For comparison of DocBank with DocLayNet, we trained only on Picture and Table clusters of each dataset. We had to exclude Text because successive paragraphs are often grouped together into a single object in DocBank. This paragraph grouping is incompatible with the individual paragraphs of DocLayNet. As can be seen in Table 5, DocLayNet trained models yield better performance compared to the previous datasets. It is noteworthy that the models trained on PubLayNet and DocBank perform very well on their own test set, but have a much lower performance on the foreign datasets. While this also applies to DocLayNet, the di/fference is far less pronounced. Thus we conclude that DocLayNet trained models are overall more robust and will produce better results for challenging, unseen layouts.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/464', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 8, 'bbox': {'l': 53.52899932861328, 't': 171.73599243164062, 'r': 295.5580139160156, 'b': 86.6500015258789, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 483)}]}]
- **headings**: ['Example Predictions']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}

### Content:

To conclude this section, we illustrate the quality of layout predictions one can expect from DocLayNet-trained models by providing a selection of examples without any further post-processing applied. Figure 6 shows selected layout predictions on pages from the test-set of DocLayNet. Results look decent in general across document categories, however one can also observe mistakes such as overlapping clusters of di/fferent classes, or entirely missing boxes due to low con/fidence.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/467', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 8, 'bbox': {'l': 317.6860046386719, 't': 603.2659912109375, 'r': 559.7169799804688, 'b': 507.22100830078125, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 573)}]}]
- **headings**: ['6 CONCLUSION']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/468', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 8, 'bbox': {'l': 317.62298583984375, 't': 504.635986328125, 'r': 558.4349975585938, 'b': 474.343994140625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 189)}]}]
- **headings**: ['6 CONCLUSION']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
To date, there is still a signi/ficant gap between human and ML accuracy on the layout interpretation task, and we hope that this work will inspire the research community to close that gap.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/470', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 443.2980041503906, 'r': 558.2009887695312, 'b': 420.8370056152344, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 191)}]}, {'self_ref': '#/texts/471', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 419.38800048828125, 'r': 559.3800048828125, 'b': 388.9570007324219, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 279)}]}, {'self_ref': '#/texts/472', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 387.50799560546875, 'r': 558.2000122070312, 'b': 365.0530090332031, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 213)}]}, {'self_ref': '#/texts/473', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 363.59698486328125, 'r': 559.3790283203125, 'b': 333.1730041503906, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 252)}]}, {'self_ref': '#/texts/474', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 331.7170104980469, 'r': 559.0260009765625, 'b': 301.2919921875, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 261)}]}, {'self_ref': '#/texts/475', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 299.83599853515625, 'r': 558.2039794921875, 'b': 277.375, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 235)}]}, {'self_ref': '#/texts/476', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 275.9259948730469, 'r': 558.9719848632812, 'b': 237.531005859375, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 316)}]}, {'self_ref': '#/texts/477', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 236.0749969482422, 'r': 558.9019775390625, 'b': 213.61399841308594, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 172)}]}, {'self_ref': '#/texts/478', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 321.197998046875, 't': 212.1649932861328, 'r': 559.2739868164062, 'b': 181.74099731445312, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 272)}]}, {'self_ref': '#/texts/479', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 317.9549865722656, 't': 180.28500366210938, 'r': 558.2020263671875, 'b': 165.79299926757812, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 149)}]}, {'self_ref': '#/texts/480', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 317.9549865722656, 't': 164.343994140625, 'r': 558.2009887695312, 'b': 141.88299560546875, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 227)}]}, {'self_ref': '#/texts/481', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 317.9549865722656, 't': 140.4340057373047, 'r': 559.2780151367188, 'b': 117.9800033569336, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 192)}]}, {'self_ref': '#/texts/482', 'parent': {'cref': '#/groups/3'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 8, 'bbox': {'l': 317.9549865722656, 't': 116.52400207519531, 'r': 558.9719848632812, 'b': 86.0989990234375, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 305)}]}]
- **headings**: ['REFERENCES']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
[4] Antonio Jimeno Yepes, Peter Zhong, and Douglas Burdick. Competition on scienti/fic literature parsing. In Proceedings of the International Conference on Document Analysis and Recognition , ICDAR, pages 605-617. LNCS 12824, SpringerVerlag, sep 2021.
...
[9] Ross B. Girshick, Je/ff Donahue, Trevor Darrell, and Jitendra Malik. Rich feature hierarchies for accurate object detection and semantic segmentation. In IEEE Conference on Computer Vision and Pattern Recognition , CVPR, pages 580-587. IEEE Computer Society, jun 2014.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/483', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.PAGE_HEADER: 'page_header'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 731.6909790039062, 'r': 347.0169982910156, 'b': 723.4240112304688, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 71)}]}]
- **headings**: ['REFERENCES']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/484', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.PAGE_HEADER: 'page_header'>, 'prov': [{'page_no': 9, 'bbox': {'l': 365.7569885253906, 't': 731.6909790039062, 'r': 558.2030029296875, 'b': 723.4240112304688, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 48)}]}]
- **headings**: ['REFERENCES']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/485', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.CAPTION: 'caption'>, 'prov': [{'page_no': 9, 'bbox': {'l': 62.32400131225586, 't': 349.7149963378906, 'r': 318.5050048828125, 'b': 343.7349853515625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 89)}]}]
- **headings**: ['REFERENCES']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/502', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 327.51800537109375, 'r': 559.8079833984375, 'b': 286.16900634765625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 388)}]}]
- **headings**: ['REFERENCES']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
Figure 6: Example layout predictions on selected pages from the DocLayNet test-set. (A, D) exhibit favourable results on coloured backgrounds. (B, C) show accurate list-item and paragraph di/fferentiation despite densely-spaced lines. (E) demonstrates good table and /figure distinction. (F) shows predictions on a Chinese patent with multiple overlaps, label confusion and missing boxes.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/503', 'parent': {'cref': '#/body'}, 'children': [], 'label': <DocItemLabel.TEXT: 'text'>, 'prov': [{'page_no': 9, 'bbox': {'l': 69.23400115966797, 't': 264.9339904785156, 'r': 295.2239990234375, 'b': 242.47999572753906, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 197)}]}]
- **headings**: ['REFERENCES']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
Diaconu, Mai Thanh Minh, Marc, albinxavi, fatih, oleg, and wanghao yang. ultralytics/yolov5: v6.0 - yolov5n nano models, robo/flow integration, tensor/flow export, opencv dnn support, October 2021.
...
- **schema_name**: docling_core.transforms.chunker.DocMeta
- **version**: 1.0.0
- **doc_items**: [{'self_ref': '#/texts/504', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 241.0240020751953, 'r': 295.12200927734375, 'b': 218.56300354003906, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 190)}]}, {'self_ref': '#/texts/505', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 217.11399841308594, 'r': 294.0419921875, 'b': 202.6219940185547, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 134)}]}, {'self_ref': '#/texts/506', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 201.17300415039062, 'r': 295.2229919433594, 'b': 178.718994140625, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 219)}]}, {'self_ref': '#/texts/507', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 177.26300048828125, 'r': 295.1199951171875, 'b': 162.7790069580078, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 100)}]}, {'self_ref': '#/texts/508', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 161.322998046875, 'r': 294.8089904785156, 'b': 122.9280014038086, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 341)}]}, {'self_ref': '#/texts/509', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 53.79800033569336, 't': 121.47200012207031, 'r': 295.22198486328125, 'b': 83.0780029296875, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 336)}]}, {'self_ref': '#/texts/510', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 317.9549865722656, 't': 264.9339904785156, 'r': 559.0260009765625, 'b': 250.4499969482422, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 153)}]}, {'self_ref': '#/texts/511', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 317.9549865722656, 't': 248.99400329589844, 'r': 558.9710083007812, 'b': 226.5399932861328, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 189)}]}, {'self_ref': '#/texts/512', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 317.9549865722656, 't': 225.08399963378906, 'r': 559.2750244140625, 'b': 194.65199279785156, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 291)}]}, {'self_ref': '#/texts/513', 'parent': {'cref': '#/groups/4'}, 'children': [], 'label': <DocItemLabel.LIST_ITEM: 'list_item'>, 'prov': [{'page_no': 9, 'bbox': {'l': 317.9549865722656, 't': 193.2030029296875, 'r': 559.3779907226562, 'b': 178.71200561523438, 'coord_origin': <CoordOrigin.BOTTOMLEFT: 'BOTTOMLEFT'>}, 'charspan': (0, 138)}]}]
- **headings**: ['REFERENCES']
- **captions**: None
- **origin**: {'mimetype': 'application/pdf', 'binary_hash': 7156212269791437020, 'filename': 'DocLayNet.pdf', 'uri': None}
...
[15] Mingxing Tan, Ruoming Pang, and Quoc V. Le. E/fficientdet: Scalable and e/fficient object detection. CoRR , abs/1911.09070, 2019.
...
[18] Nikolaos Livathinos, Cesar Berrospi, Maksym Lysak, Viktor Kuropiatnyk, Ahmed Nassar, Andre Carvalho, Michele Dol/fi, Christoph Auer, Kasper Dinkla, and Peter W. J. Staar. Robust pdf document conversion using recurrent neural networks. In Proceedings of the 35th Conference on Arti/ficial Intelligence , AAAI, pages 1513715145, feb 2021.
...
[21] Peng Zhang, Can Li, Liang Qiao, Zhanzhan Cheng, Shiliang Pu, Yi Niu, and Fei Wu. Vsr: A uni/fied framework for document layout analysis combining vision, semantics and relations, 2021.
[22] Peter W J Staar, Michele Dol/fi, Christoph Auer, and Costas Bekas. Corpus conversion service: A machine learning platform to ingest documents at scale. In Proceedings of the 24th ACM SIGKDD International Conference on Knowledge Discovery and Data Mining , KDD, pages 774-782. ACM, 2018.
